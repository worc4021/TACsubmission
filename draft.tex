...
%% Ticket list
\openTickets{Manuel:wlog,Manuel:invertability:assumption,Mark:log:bounds,Mark:proof:cor15}
...
M = \max \Bigl\{ n , \todo{Mark:log:bounds}{\bigl\lfloor 
\log_{\rho}(r_1/r_2)\bigr\rfloor}\Bigr\},
...
M = \max \biggl\{ n , 
\todo{Mark:log:bounds}{
\biggl\lfloor \log_{\rho}\Bigl(\frac{c_1-(1-\rho)^{-1}c_3}{c_2-(1-\rho)^{-1}c_3}\Bigr)\biggr\rfloor \biggr\}}.
\end{equation}
\end{cor}
%
