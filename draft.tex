...
performance criterion for all possible realisations of model uncertainty.
%
Introduced by~\cite{Witsenhausen:1968} the min-max RMPC problem is formulated as a sequence of games in which an
adversary maximises the effect model of uncertainty on a performance objective and the controller solves the optimal
...
%
Earlier algorithms either failed to guarantee finite determinability
