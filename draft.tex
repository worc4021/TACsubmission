...
%
\textcolor{red}{I'm not sure this works. This only shows that it is necessary for polytopic sets, but polytopic sets are a subset of all possible sets. There might be sets for which this still works}
\end{proof}
%
...
%
\textcolor{red}{Constraint~\eqref{eq:state:constraints} corresponds to the stage constraint~$\mathcal Z_m$ defined 
